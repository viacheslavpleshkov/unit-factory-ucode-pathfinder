...
SRC		= 	mx_printerr_pf.c mx_validation.c mx_validation_cmd_args.c mx_validation_file_dexist.c \
			...
			mx_graph_island_create.c mx_graph_island_add.c mx_graph_island_get.c mx_graph_link_create.c \
			mx_graph_link_add.c mx_graph_link_set.c mx_graph_path_create.c mx_graph_path_push_back.c \
			mx_graph_path_push_front.c mx_file_to_arr.c mx_graph_parse.c mx_graph_algorithm.c mx_print_paths.c \
			mx_file_crate.c mx_algorithm_create.c mx_main_create.c main.c
